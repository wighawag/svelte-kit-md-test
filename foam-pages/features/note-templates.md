...
![Create new template GIF](../../static/images/create-new-template.gif)
...
![Create new note from template GIF](../../static/images/create-new-note-from-template.gif)
...
![Template Picker annotated with attributes](../../static/images/template-picker-annotated.png)
